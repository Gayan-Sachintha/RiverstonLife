        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color: #565E57;" id="accordionSidebar">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center my-4" href="index.php">
                <h2 style="font-size: 24px; font-weight:900;">RIVERSTON LIFE</h2>
        </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseStudent" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">View Calendar</a>
                        <a class="collapse-item" href="#">Update Calendar</a>
                        <a class="collapse-item" href="#">Cancel Event</a>
                    </div>
                </div>
            </li>
