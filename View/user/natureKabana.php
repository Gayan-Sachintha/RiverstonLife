...
<head>
   ...
   <style>
        ...
        .villViewhead {
            background-image: url('../assets/images/ecvilla.jpg');
            background-size: cover;
            background-position: center;
            min-height: 400px;
        }
...
<body>
    ...
    <div class="row villViewhead">
        ...
        <h1 style="color: white; text-align: center; margin-top: 100px; z-index: 1;"></h1>
    </div>
</div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <ul>
                                                            ...
                                                            <li>Occupancy: Family Cabanas / Double Rooms Available</li>
