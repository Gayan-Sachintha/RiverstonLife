  ...
  <nav>
    <div class="col-12">
      <div class="row" style="background-color: #222823;">
        <div class="col-1"></div>
        <div class="col-2 col-md-3 p-4">
          <h3 style="color: white;">RIVERSTON LIFE</h3>
        </div>
        <div class="col-3"></div>
        <div class="col-5 mt-4" style="color: white;">
          <div class="row nav-layout">
            ...
            <div class="col-12 col-md-2 nav-style"><a href="../user/contact.php" style="color: inherit; text-decoration: none;">ABOUT US</a></div>          
          </div>
        </div>
        <div class="col-1"></div>
      </div>
