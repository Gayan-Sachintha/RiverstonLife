...
<body>
    ...
    <!-- <div class="col-12 col-md-4 mt-2 mb-4 mx-4 mx-md-0">
        <div class="card" style="width: 18rem;border-radius: 50px;background-color: #222823;border: none;">
            ...
            <img class="card-img-top mx-3" src="../assets/images/villaPackages/ecoResort packge1.jpg" alt="Card image cap" style="width: 90%;border-radius: 10%;">
            <div class="card-body mb-2">
                <p class="card-text text-center text-white">
    ...
    <div class="col-12 col-md-4 mt-2 mb-4 mx-4 mx-md-0">
        <div class="card" style="width: 18rem;border-radius: 50px;background-color: #222823;border: none;">
            ...
            <img class="card-img-top mx-3" src="../assets/images/villaPackages/ecoResort packge2.jpg" alt="Card image cap" style="width: 90%;border-radius: 10%;">
            <div class="card-body mb-2">
                <p class="card-text text-center text-white">
    ...
    <div class="col-12 col-md-4 mt-2 mb-4 mx-4 mx-md-0">
        <div class="card" style="width: 18rem;border-radius: 50px;background-color: #222823;border: none;">
            ...
            <img class="card-img-top mx-3" src="../assets/images/villaPackages/ecoResort packge3.jpg" alt="Card image cap" style="width: 90%;border-radius: 10%;">
            <div class="card-body mb-2">
                <p class="card-text text-center text-white">
