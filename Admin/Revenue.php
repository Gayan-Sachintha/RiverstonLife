            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Teacher's Revenue</h1>
                    </div>
                    ...
                    <div class="col-12 ">
                        <div class="card shadow mb-4">
                            <table class="table" style="align-items: center;">
                                ...
                                <tbody>
                                    <tr>
                                        <th><img src="Final.png" style="width: 50px;height: 50px;"></th>
                                        <td>Physics</td>
                                        <td>Mr/Mrs</td>
                                        ...
                                        <td>
                                            <div class="row">
                                            <span class="text-dark bg-warning p-2 rounded">Pending</span>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
