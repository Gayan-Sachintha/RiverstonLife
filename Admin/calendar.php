...
<head>
    <title>
        Jquery Fullcalandar CRUD(Create, Read, Update, Delete) with PHP Jquery
        Ajax and Mysql
    </title>
...
<body>
    ...
    <div style="display:flex; justify-content: center; align-items: center; background-color: #565E57; padding: 25px;">
